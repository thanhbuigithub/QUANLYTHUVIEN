...
CREATE TABLE `ngon_ngu` (
  ...
  `ten_ngon_ngu` varchar(50) DEFAULT NULL,
...
INSERT INTO `ngon_ngu` VALUES (1,'Tiếng Anh',NULL),(2,'Tiếng Trung',NULL),(3,'Tiếng Pháp',NULL),(4,'Tiếng Nhật',NULL),(5,'Tiếng Việt',NULL);
